								...
								<div class=" bg-white rounded-lg px-5 w-[40%]">
									...
									<form action="" method="POST" id="formEdit" class=" grid grid-cols-3 gap-2 py-5">
										...
										<div class=" w-full relative inline-block col-start-2 col-end-3 mb-3">
											...
											<ul id="listMentor-<?= $row['id_class'] ?>" class=" text-left text-sm hidden absolute left-0 mt-2 border-2 border-white bg-white shadow-md rounded-md">
										...
										<div class=" w-full relative inline-block col-start-3 col-end-4">
											...
											<ul id="listMateri-<?= $row['id_class'] ?>" class=" text-left text-sm hidden absolute left-0 mt-2 border-2 border-white bg-white shadow-md rounded-md">
